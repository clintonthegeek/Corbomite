...
| Paste/drop images, paste HTML→MD | 🟡 | Cluster N CLOSED on `feature/rich-clipboard` (N5 passed, Markoff `bafa3095`). HTML/RTF↔MD + Copy as on all leaves; LO Block Quote round-trip confirmed. Image paste/drop still absent. Plan: [`superpowers/plans/2026-08-20-cluster-n-rich-clipboard.md`](superpowers/plans/2026-08-20-cluster-n-rich-clipboard.md) |
