...
| Paste/drop images, paste HTML→MD | 🟡 | Cluster N (`feature/rich-clipboard`): HTML/RTF→markdown smart paste + Copy as landed in `ClipboardCodec` and all leaves (canvas/Live/Source/Styled, Markoff `365e9b91`). Image paste/drop still absent. Phase 5 eyeball open. Plan: [`superpowers/plans/2026-08-20-cluster-n-rich-clipboard.md`](superpowers/plans/2026-08-20-cluster-n-rich-clipboard.md) |
