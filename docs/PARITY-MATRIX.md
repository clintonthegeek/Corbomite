...
2. ~~**No completion** for `[[` or `#` — typed blind.~~ **FIXED — completion revival A1 (`[[` names + `#` tags, all editable leaves); aliases/headings/blocks pending A2/A3.**
