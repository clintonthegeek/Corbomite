...
| Q | Internal-plugin wrapping + permissions | [full](2026-04-16-cluster-q-internal-plugin-wrapping.md) | Full | Ready — Tasks 1-6 landed; 7-20 retargeted onto Q.0 proxies (2026-04-17) | Tasks 1-6 shipped on `35a9c07`, `b01b998`, `4fa4509`, `b9a271d`, `b67e7ed`. Task 7 became a no-op pointer to Q.0 P9 via commit `02f8898` (plan retarget). Tasks 8–20 await execution dispatch. |
