...
| L | Workspace/KDDW stabilization & nativization | [full](2026-08-17-cluster-l-workspace-stabilization.md) | Full | **L0-L2 landed 2026-08-17; L3-L5 not started** | Full re-evaluation of the tab/dock layer (2026-08-17) found three disease clusters — teardown fragility, persistence split-brain, Obsidian-literalism residue. L0 (compat-boundary doctrine, [spec](../specs/2026-08-17-workspace-compat-boundary.md)) signed off; L1 (crash-safety: `destroyLeaves` primitive, findings A1/A3/A4) landed ASAN-clean, unblocking K Phase 4; L2 (one writer, full fidelity: B1/C2/denylist/B4 fixed, B3 id-assignment fixed with a dimension-round-trip gap punch-listed `[cluster-l]`) landed. Next: L3 (cruft removal) or L4 (native UX polish) — no hard ordering. Detail: `decisions-archive.md` (2026-08-17 entries). |
