...
**Last updated:** 2026-08-20 — Cluster N CLOSED (N5 eyeball passed on `feature/rich-clipboard`; merge pending). Prior same-day: N0–N4 + quote-export fix. Prior: 2026-08-19 — Cluster M opened. Prior: 2026-08-17 — Cluster L. Prior: 2026-06-10 — archive sweep.
...
| N | Rich clipboard (copy-as + smart paste) | [full](2026-08-20-cluster-n-rich-clipboard.md) | Full | **CLOSED 2026-08-20 on `feature/rich-clipboard` (N5 passed). Merge pending.** | Markoff `ClipboardCodec` + all leaves + Edit menu; LO Block Quote export fixed (`bafa3095`). Image paste/drop out of scope. **Post-reset N** — not legacy Cluster N. |
