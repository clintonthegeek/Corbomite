...
> **⚠ OBSOLETE — archived 2026-06-10.** The goal (promote blocks out of `QTextDocument` into peer items) is the new foundation's baseline — every block is a peer QML delegate (Markoff `v0.7.0-freeze`, merged 2026-05-25). Superseded by Markoff E5 (math/Mermaid Live parity). Do not dispatch.
