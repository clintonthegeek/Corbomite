...
LucideIconRegistrar *PluginContext::icons() const
{
    if (!hasPermission(QLatin1String(kUiIcons)) || !m_lucideIconRegistry) return nullptr;
    if (!m_lucideIconRegistrar) {
        m_lucideIconRegistrar = new LucideIconRegistrar(
